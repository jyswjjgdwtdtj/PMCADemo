...
public class KeyEventActivity extends BaseActivity {
    ...
    protected boolean onUpperDialChanged(int value) {
        return logDial("upper dial", value);
    }

    protected boolean onLowerDialChanged(int value) {
        return logDial("lower dial", value);
    }

    protected boolean onModeDialChanged(int value) {
        return logDial("mode dial", value);
    }
}
